  ...
  return (
    <>    
        ...
        <div className="max-w-screen-xl mx-auto pt-[50px] px-4">
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="pb-[50px]">
              <h1 className="font-semibold text-[24px] text-white">[EDUFREE]</h1>
              <p className="text-white">Bangun dan wujudkan cita bersama <br /> EDUFREE</p>
            </div>
            <div className="flex flex-row flex-wrap justify-between gap-x-8 gap-y-8 w-full lg:w-1/2">
              <div className="text-white flex flex-col gap-y-2">
                ...
                <a href="/" className="text-[18px]">Twitter</a>
                <a href="/" className="text-[18px]">TwitterLinkedIn</a>
              </div>
              <div className="text-white flex flex-col gap-y-2">
                <h1 className="text-[20px] mb-4">Program</h1>
                <a href="/" className="text-[18px]">Merdeka Belajar</a>
                <a href="/" className="text-[18px]">Pinterpreneur</a>
              </div>
              <div className="text-white flex flex-col gap-y-2">
                <h1 className="text-[20px] mb-4">Dukungan</h1>
                <a href="/" className="text-[18px]">Tentang Kami</a>
                <a href="/" className="text-[18px]">Ketentuan</a>
                <a href="/" className="text-[18px]">Kebijakan Privasi</a>
              </div>
            </div>
          </div>
      ...
      <nav className="max-w-screen-xl bg-white mx-auto block md:flex justify-between items-center py-6 px-4">
        <div className="font-medium text-center">&copy; Copyright EDUFREE 2021 - 2022</div>
        <div className="flex gap-4 lg:gap-8 text-sm lg:text-normal mt-4 md:mt-0 justify-center">
          ...
          <Link to="/" className="uppercase">Tentang Kami</Link>
          <Link to="/" className="uppercase">Kursus</Link>
